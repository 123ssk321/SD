...
public interface Result<T> {
	 ...
	 * @return
	 */
	static <T> Result<T> redirect(Queue<String> uris) {
		return new ErrorResult<>(ErrorCode.REDIRECT, uris);
	}
}
 ...
 * 
 */
class OkResult<T> implements tp.api.service.java.Result<T> {
...
class ErrorResult<T> implements tp.api.service.java.Result<T> {
